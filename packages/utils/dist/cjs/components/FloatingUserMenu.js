...
exports["default"] = exports.useUserMenu = exports.UserMenuContext = void 0;
...
var UserMenuContextProvider = function UserMenuContextProvider(_ref) {
  ...
  var isMountedRef = useIsMountedRef(); //const [avatarWidth, setAvatarWidth] = useState(32);
  ...
  var clientHandler = (0, _react.useRef)(null); //({ AppIcon, title, date, msg, footer })
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return clientHandler.current.query({
                query: (0, _graphqlTag["default"])(_queries.listNotificationsByDate),
                variables: {
            ...
            case 2:
              ...
              console.log("NOTIFICATION LIST", notifications); //console.log("NOTIFICATION CARD", NotificationCard);

              cardList = notifications.data.listNotificationsByDate.items.map(function (c, i) {
  ...
  var onUpdate = (0, _react.useCallback)(function (cnt) {
