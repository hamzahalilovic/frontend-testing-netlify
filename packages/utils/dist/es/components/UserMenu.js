...
var config = process.env.REACT_APP_STAGE === "prod" ? prod : dev; //import config from "../config";
    ...
    var WithUsermenu = function WithUsermenu(props) {
              ...
              switch (_context.prev = _context.next) {
                case 0:
                  ...
                  if (action === "logout") {
                    ...
                    try {
                      //console.log("LOGOUT...");
                      setLogout(true); //await Auth.signOut();

                      userAuth(false); //history.replace("/");
                    } catch (e) {
      ...
      return /*#__PURE__*/_react["default"].createElement(_FloatingUserMenu["default"], {
        ...
        onHome: function onHome() {
          console.log("HOME CLICK..."); //history.replace("/");
